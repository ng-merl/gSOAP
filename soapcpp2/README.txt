...
the service and how. You can run Doxygen on it to generate a nice set of pages.
The header file is then processed by the gSOAP stub and skeleton compiler to
...
XMethodsQuerySoap.nsmap	A XML-to-C/C++ namespare mapping table

To compile a client you need to compile and link soapC.cpp, soapClient.cpp, and
stdsoap2.cpp (or libgsoap) with your code. Use #include "soapH.h" in your code
and #include the .nsmap file (XMethodsQuerySoap.nsmap) to import all gSOAP
definitions and the namespace mapping tablle.

To compile a server you need to compile and link soapC.cpp, soapServer.cpp, and
stdsoap2.cpp (or libgsoap) with your code. Use #include "soapH.h" in your code
and #include the .nsmap (XMethodsQuerySoap.nsmap) to import all gSOAP
definitions.
...
support: engelen AT acm DOT org.
