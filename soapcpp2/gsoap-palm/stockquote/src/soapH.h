...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__getQuote(struct soap*, struct ns__getQuote const*);
SOAP_FMAC3 void SOAP_FMAC4 soap_mark_ns__getQuote(struct soap*, const struct ns__getQuote *);
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__getQuoteResponse(struct soap*, struct ns__getQuoteResponse const*);
SOAP_FMAC3 void SOAP_FMAC4 soap_mark_ns__getQuoteResponse(struct soap*, const struct ns__getQuoteResponse *);
