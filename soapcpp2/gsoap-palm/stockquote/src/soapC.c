...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.7.0e 2005-01-24 14:07:32 GMT")
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	{
	case SOAP_TYPE_ns__getQuote:
		soap_mark_ns__getQuote(soap, (const struct ns__getQuote *)ptr);
		break;
	case SOAP_TYPE_ns__getQuoteResponse:
		soap_mark_ns__getQuoteResponse(soap, (const struct ns__getQuoteResponse *)ptr);
		break;
	case SOAP_TYPE_PointerTofloat:
		soap_mark_PointerTofloat(soap, (float *const*)ptr);
		break;
	case SOAP_TYPE__QName:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__getQuote(struct soap *soap, struct ns__getQuote const*a)
{
	soap_mark_ns__getQuote(soap, a);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_mark_ns__getQuote(struct soap *soap, const struct ns__getQuote *a)
{
...
SOAP_FMAC3 struct ns__getQuote * SOAP_FMAC4 soap_in_ns__getQuote(struct soap *soap, const char *tag, struct ns__getQuote *a, const char *type)
{
	...
	{	a = (struct ns__getQuote *)soap_id_forward(soap, soap->href, (void**)a, SOAP_TYPE_ns__getQuote, 0, sizeof(struct ns__getQuote), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__getQuoteResponse(struct soap *soap, struct ns__getQuoteResponse const*a)
{
	soap_mark_ns__getQuoteResponse(soap, a);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_mark_ns__getQuoteResponse(struct soap *soap, const struct ns__getQuoteResponse *a)
{
...
SOAP_FMAC3 struct ns__getQuoteResponse * SOAP_FMAC4 soap_in_ns__getQuoteResponse(struct soap *soap, const char *tag, struct ns__getQuoteResponse *a, const char *type)
{
	...
	{	a = (struct ns__getQuoteResponse *)soap_id_forward(soap, soap->href, (void**)a, SOAP_TYPE_ns__getQuoteResponse, 0, sizeof(struct ns__getQuoteResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
