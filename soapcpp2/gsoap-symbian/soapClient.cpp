/* soapClient.cpp
   Generated by gSOAP 2.6.0 from interop2.h
...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.6.0 2004-04-12 14:13:35 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoString(struct soap *soap, const char *URL, const char *action, char *inputString, char *&_return)
{
	...
	soap_default_xsd__string(soap, &_return);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoStringResponse = soap_get_ns__echoStringResponse(soap, NULL, "ns:echoStringResponse", "ns:echoStringResponse");
	if (soap->error)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoStringArray(struct soap *soap, const char *URL, const char *action, struct ArrayOfstring inputStringArray, struct ArrayOfstring &_return)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoStringArrayResponse = soap_get_ns__echoStringArrayResponse(soap, NULL, "ns:echoStringArrayResponse", "ns:echoStringArrayResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoInteger(struct soap *soap, const char *URL, const char *action, long inputInteger, long &_return)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoIntegerResponse = soap_get_ns__echoIntegerResponse(soap, NULL, "ns:echoIntegerResponse", "ns:echoIntegerResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoIntegerArray(struct soap *soap, const char *URL, const char *action, struct ArrayOfint inputIntegerArray, struct ArrayOfint &_return)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoIntegerArrayResponse = soap_get_ns__echoIntegerArrayResponse(soap, NULL, "ns:echoIntegerArrayResponse", "ns:echoIntegerArrayResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoFloat(struct soap *soap, const char *URL, const char *action, float inputFloat, float &_return)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoFloatResponse = soap_get_ns__echoFloatResponse(soap, NULL, "ns:echoFloatResponse", "ns:echoFloatResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoFloatArray(struct soap *soap, const char *URL, const char *action, struct ArrayOffloat inputFloatArray, struct ArrayOffloat &_return)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoFloatArrayResponse = soap_get_ns__echoFloatArrayResponse(soap, NULL, "ns:echoFloatArrayResponse", "ns:echoFloatArrayResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoStruct(struct soap *soap, const char *URL, const char *action, struct s__SOAPStruct inputStruct, struct ns__echoStructResponse &result)
{
	struct ns__echoStruct soap_tmp_ns__echoStruct;
	soap_tmp_ns__echoStruct.inputStruct=inputStruct;
	soap_begin(soap);
	soap_serializeheader(soap);
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_ns__echoStructResponse(soap, &result, "ns:echoStructResponse", "ns:echoStructResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoStructArray(struct soap *soap, const char *URL, const char *action, struct ArrayOfSOAPStruct inputStructArray, struct ArrayOfSOAPStruct &_return)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoStructArrayResponse = soap_get_ns__echoStructArrayResponse(soap, NULL, "ns:echoStructArrayResponse", "ns:echoStructArrayResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoVoid(struct soap *soap, const char *URL, const char *action, struct ns__echoVoidResponse &result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_ns__echoVoidResponse(soap, &result, "ns:echoVoidResponse", "ns:echoVoidResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoBase64(struct soap *soap, const char *URL, const char *action, struct xsd__base64Binary inputBase64, struct xsd__base64Binary &_return)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoBase64Response = soap_get_ns__echoBase64Response(soap, NULL, "ns:echoBase64Response", "ns:echoBase64Response");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoDate(struct soap *soap, const char *URL, const char *action, char *inputDate, char *&_return)
{
	...
	if (soap_connect(soap, URL, action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	soap_default_xsd__dateTime(soap, &_return);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoDateResponse = soap_get_ns__echoDateResponse(soap, NULL, "ns:echoDateResponse", "ns:echoDateResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoHexBinary(struct soap *soap, const char *URL, const char *action, struct xsd__hexBinary inputHexBinary, struct xsd__hexBinary &_return)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoHexBinaryResponse = soap_get_ns__echoHexBinaryResponse(soap, NULL, "ns:echoHexBinaryResponse", "ns:echoHexBinaryResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoDecimal(struct soap *soap, const char *URL, const char *action, char *inputDecimal, char *&_return)
{
	...
	if (soap_connect(soap, URL, action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	soap_default_xsd__decimal(soap, &_return);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoDecimalResponse = soap_get_ns__echoDecimalResponse(soap, NULL, "ns:echoDecimalResponse", "ns:echoDecimalResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoBoolean(struct soap *soap, const char *URL, const char *action, bool inputBoolean, bool &_return)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echoBooleanResponse = soap_get_ns__echoBooleanResponse(soap, NULL, "ns:echoBooleanResponse", "ns:echoBooleanResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoStructAsSimpleTypes(struct soap *soap, const char *URL, const char *action, struct s__SOAPStruct _inputStruct, struct ns__echoStructAsSimpleTypesResponse &result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_ns__echoStructAsSimpleTypesResponse(soap, &result, "ns:echoStructAsSimpleTypesResponse", "ns:echoStructAsSimpleTypesResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoSimpleTypesAsStruct(struct soap *soap, const char *URL, const char *action, char *inputString, long *inputInteger, float *inputFloat, struct ns__echoSimpleTypesAsStructResponse &result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_ns__echoSimpleTypesAsStructResponse(soap, &result, "ns:echoSimpleTypesAsStructResponse", "ns:echoSimpleTypesAsStructResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echo2DStringArray(struct soap *soap, const char *URL, const char *action, struct ArrayOfstring2D _input2DStringArray, struct ArrayOfstring2D &_return)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__echo2DStringArrayResponse = soap_get_ns__echo2DStringArrayResponse(soap, NULL, "ns:echo2DStringArrayResponse", "ns:echo2DStringArrayResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoNestedStruct(struct soap *soap, const char *URL, const char *action, struct s__SOAPStructStruct _inputStruct, struct ns__echoNestedStructResponse &result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_ns__echoNestedStructResponse(soap, &result, "ns:echoNestedStructResponse", "ns:echoNestedStructResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_ns__echoNestedArray(struct soap *soap, const char *URL, const char *action, struct s__SOAPArrayStruct _inputStruct, struct ns__echoNestedArrayResponse &result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_ns__echoNestedArrayResponse(soap, &result, "ns:echoNestedArrayResponse", "ns:echoNestedArrayResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_m__echoVoid(struct soap *soap, const char *URL, const char *action, struct m__echoVoidResponse &result)
{
	...
	if (!URL)
		URL = "http://www.cs.fsu.edu/~engelen";
	soap_begin(soap);
	soap_serializeheader(soap);
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_m__echoVoidResponse(soap, &result, "m:echoVoidResponse", "m:echoVoidResponse");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
