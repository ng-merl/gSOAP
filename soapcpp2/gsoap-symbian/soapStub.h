/* soapStub.h
   Generated by gSOAP 2.7.8c from interop_all.h
...
{
public:
	char *_return;	/* RPC return element */	/* required element of type xsd:string */
};
#endif
...
{
public:
	struct ArrayOfstring _return;	/* RPC return element */	/* required element of type ArrayOfstring */
};
#endif
...
{
public:
	long _return;	/* RPC return element */	/* required element of type xsd:int */
};
#endif
...
{
public:
	struct ArrayOfint _return;	/* RPC return element */	/* required element of type ArrayOfint */
};
#endif
...
{
public:
	float _return;	/* RPC return element */	/* required element of type xsd:float */
};
#endif
...
{
public:
	struct ArrayOffloat _return;	/* RPC return element */	/* required element of type ArrayOffloat */
};
#endif
...
{
public:
	struct s__SOAPStruct _return;	/* RPC return element */	/* required element of type s:SOAPStruct */
};
#endif
...
{
public:
	struct ArrayOfSOAPStruct _return;	/* RPC return element */	/* required element of type ArrayOfSOAPStruct */
};
#endif
...
{
public:
	struct xsd__base64Binary _return;	/* RPC return element */	/* required element of type xsd:base64Binary */
};
#endif
...
{
public:
	char *_return;	/* RPC return element */	/* required element of type xsd:dateTime */
};
#endif
...
{
public:
	struct xsd__hexBinary _return;	/* RPC return element */	/* required element of type xsd:hexBinary */
};
#endif
...
{
public:
	char *_return;	/* RPC return element */	/* required element of type xsd:decimal */
};
#endif
...
{
public:
	bool _return;	/* RPC return element */	/* required element of type xsd:boolean */
};
#endif
...
{
public:
	char *_outputString;	/* RPC return element */	/* optional element of type xsd:string */
...
{
public:
	struct ArrayOfstring2D _return;	/* RPC return element */	/* required element of type ArrayOfstring2D */
};
#endif
...
{
public:
	struct s__SOAPStructStruct _return;	/* RPC return element */	/* required element of type s:SOAPStructStruct */
};
#endif
...
{
public:
	struct s__SOAPArrayStruct _return;	/* RPC return element */	/* required element of type s:SOAPArrayStruct */
};
#endif
