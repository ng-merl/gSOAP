...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.0c 2004-10-09 19:31:25 GMT")
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	{
	case SOAP_TYPE_m__echoVoid:
		soap_mark_m__echoVoid(soap, (const struct m__echoVoid *)ptr);
		break;
	case SOAP_TYPE_m__echoVoidResponse:
		soap_mark_m__echoVoidResponse(soap, (const struct m__echoVoidResponse *)ptr);
		break;
	case SOAP_TYPE_ns__echoNestedArray:
		soap_mark_ns__echoNestedArray(soap, (const struct ns__echoNestedArray *)ptr);
		break;
	case SOAP_TYPE_ns__echoNestedArrayResponse:
		soap_mark_ns__echoNestedArrayResponse(soap, (const struct ns__echoNestedArrayResponse *)ptr);
		break;
	case SOAP_TYPE_s__SOAPArrayStruct:
		soap_mark_s__SOAPArrayStruct(soap, (const struct s__SOAPArrayStruct *)ptr);
		break;
	case SOAP_TYPE_ns__echoNestedStruct:
		soap_mark_ns__echoNestedStruct(soap, (const struct ns__echoNestedStruct *)ptr);
		break;
	case SOAP_TYPE_ns__echoNestedStructResponse:
		soap_mark_ns__echoNestedStructResponse(soap, (const struct ns__echoNestedStructResponse *)ptr);
		break;
	case SOAP_TYPE_s__SOAPStructStruct:
		soap_mark_s__SOAPStructStruct(soap, (const struct s__SOAPStructStruct *)ptr);
		break;
	case SOAP_TYPE_ns__echo2DStringArray:
		soap_mark_ns__echo2DStringArray(soap, (const struct ns__echo2DStringArray *)ptr);
		break;
	case SOAP_TYPE_ns__echo2DStringArrayResponse:
		soap_mark_ns__echo2DStringArrayResponse(soap, (const struct ns__echo2DStringArrayResponse *)ptr);
		break;
	case SOAP_TYPE_ArrayOfstring2D:
		soap_mark_ArrayOfstring2D(soap, (const struct ArrayOfstring2D *)ptr);
		break;
	case SOAP_TYPE_ns__echoSimpleTypesAsStruct:
		soap_mark_ns__echoSimpleTypesAsStruct(soap, (const struct ns__echoSimpleTypesAsStruct *)ptr);
		break;
	case SOAP_TYPE_ns__echoSimpleTypesAsStructResponse:
		soap_mark_ns__echoSimpleTypesAsStructResponse(soap, (const struct ns__echoSimpleTypesAsStructResponse *)ptr);
		break;
	case SOAP_TYPE_ns__echoStructAsSimpleTypes:
		soap_mark_ns__echoStructAsSimpleTypes(soap, (const struct ns__echoStructAsSimpleTypes *)ptr);
		break;
	case SOAP_TYPE_ns__echoStructAsSimpleTypesResponse:
		soap_mark_ns__echoStructAsSimpleTypesResponse(soap, (const struct ns__echoStructAsSimpleTypesResponse *)ptr);
		break;
	case SOAP_TYPE_ns__echoBoolean:
		soap_mark_ns__echoBoolean(soap, (const struct ns__echoBoolean *)ptr);
		break;
	case SOAP_TYPE_ns__echoBooleanResponse:
		soap_mark_ns__echoBooleanResponse(soap, (const struct ns__echoBooleanResponse *)ptr);
		break;
	case SOAP_TYPE_ns__echoDecimal:
		soap_mark_ns__echoDecimal(soap, (const struct ns__echoDecimal *)ptr);
		break;
	case SOAP_TYPE_ns__echoDecimalResponse:
		soap_mark_ns__echoDecimalResponse(soap, (const struct ns__echoDecimalResponse *)ptr);
		break;
	case SOAP_TYPE_ns__echoHexBinary:
		soap_mark_ns__echoHexBinary(soap, (const struct ns__echoHexBinary *)ptr);
		break;
	case SOAP_TYPE_ns__echoHexBinaryResponse:
		soap_mark_ns__echoHexBinaryResponse(soap, (const struct ns__echoHexBinaryResponse *)ptr);
		break;
	case SOAP_TYPE_xsd__hexBinary:
		soap_mark_xsd__hexBinary(soap, (const struct xsd__hexBinary *)ptr);
		break;
	case SOAP_TYPE_ns__echoDate:
		soap_mark_ns__echoDate(soap, (const struct ns__echoDate *)ptr);
		break;
	case SOAP_TYPE_ns__echoDateResponse:
		soap_mark_ns__echoDateResponse(soap, (const struct ns__echoDateResponse *)ptr);
		break;
	case SOAP_TYPE_ns__echoBase64:
		soap_mark_ns__echoBase64(soap, (const struct ns__echoBase64 *)ptr);
		break;
	case SOAP_TYPE_ns__echoBase64Response:
		soap_mark_ns__echoBase64Response(soap, (const struct ns__echoBase64Response *)ptr);
		break;
	case SOAP_TYPE_xsd__base64Binary:
		soap_mark_xsd__base64Binary(soap, (const struct xsd__base64Binary *)ptr);
		break;
	case SOAP_TYPE_ns__echoVoid:
		soap_mark_ns__echoVoid(soap, (const struct ns__echoVoid *)ptr);
		break;
	case SOAP_TYPE_ns__echoVoidResponse:
		soap_mark_ns__echoVoidResponse(soap, (const struct ns__echoVoidResponse *)ptr);
		break;
	case SOAP_TYPE_ns__echoStructArray:
		soap_mark_ns__echoStructArray(soap, (const struct ns__echoStructArray *)ptr);
		break;
	case SOAP_TYPE_ns__echoStructArrayResponse:
		soap_mark_ns__echoStructArrayResponse(soap, (const struct ns__echoStructArrayResponse *)ptr);
		break;
	case SOAP_TYPE_ArrayOfSOAPStruct:
		soap_mark_ArrayOfSOAPStruct(soap, (const struct ArrayOfSOAPStruct *)ptr);
		break;
	case SOAP_TYPE_ns__echoStruct:
		soap_mark_ns__echoStruct(soap, (const struct ns__echoStruct *)ptr);
		break;
	case SOAP_TYPE_ns__echoStructResponse:
		soap_mark_ns__echoStructResponse(soap, (const struct ns__echoStructResponse *)ptr);
		break;
	case SOAP_TYPE_s__SOAPStruct:
		soap_mark_s__SOAPStruct(soap, (const struct s__SOAPStruct *)ptr);
		break;
	case SOAP_TYPE_ns__echoFloatArray:
		soap_mark_ns__echoFloatArray(soap, (const struct ns__echoFloatArray *)ptr);
		break;
	case SOAP_TYPE_ns__echoFloatArrayResponse:
		soap_mark_ns__echoFloatArrayResponse(soap, (const struct ns__echoFloatArrayResponse *)ptr);
		break;
	case SOAP_TYPE_ArrayOffloat:
		soap_mark_ArrayOffloat(soap, (const struct ArrayOffloat *)ptr);
		break;
	case SOAP_TYPE_ns__echoFloat:
		soap_mark_ns__echoFloat(soap, (const struct ns__echoFloat *)ptr);
		break;
	case SOAP_TYPE_ns__echoFloatResponse:
		soap_mark_ns__echoFloatResponse(soap, (const struct ns__echoFloatResponse *)ptr);
		break;
	case SOAP_TYPE_ns__echoIntegerArray:
		soap_mark_ns__echoIntegerArray(soap, (const struct ns__echoIntegerArray *)ptr);
		break;
	case SOAP_TYPE_ns__echoIntegerArrayResponse:
		soap_mark_ns__echoIntegerArrayResponse(soap, (const struct ns__echoIntegerArrayResponse *)ptr);
		break;
	case SOAP_TYPE_ArrayOfint:
		soap_mark_ArrayOfint(soap, (const struct ArrayOfint *)ptr);
		break;
	case SOAP_TYPE_ns__echoInteger:
		soap_mark_ns__echoInteger(soap, (const struct ns__echoInteger *)ptr);
		break;
	case SOAP_TYPE_ns__echoIntegerResponse:
		soap_mark_ns__echoIntegerResponse(soap, (const struct ns__echoIntegerResponse *)ptr);
		break;
	case SOAP_TYPE_ns__echoStringArray:
		soap_mark_ns__echoStringArray(soap, (const struct ns__echoStringArray *)ptr);
		break;
	case SOAP_TYPE_ns__echoStringArrayResponse:
		soap_mark_ns__echoStringArrayResponse(soap, (const struct ns__echoStringArrayResponse *)ptr);
		break;
	case SOAP_TYPE_ArrayOfstring:
		soap_mark_ArrayOfstring(soap, (const struct ArrayOfstring *)ptr);
		break;
	case SOAP_TYPE_ns__echoString:
		soap_mark_ns__echoString(soap, (const struct ns__echoString *)ptr);
		break;
	case SOAP_TYPE_ns__echoStringResponse:
		soap_mark_ns__echoStringResponse(soap, (const struct ns__echoStringResponse *)ptr);
		break;
	case SOAP_TYPE_xsd__decimal:
	...
	case SOAP_TYPE_PointerTounsignedByte:
		...
		break;
	case SOAP_TYPE_PointerToPointerTos__SOAPStruct:
		soap_mark_PointerToPointerTos__SOAPStruct(soap, (struct s__SOAPStruct **const*)ptr);
		break;
	case SOAP_TYPE_PointerTos__SOAPStruct:
		soap_mark_PointerTos__SOAPStruct(soap, (struct s__SOAPStruct *const*)ptr);
		break;
	case SOAP_TYPE_PointerToPointerToxsd__float:
		soap_mark_PointerToPointerToxsd__float(soap, (float **const*)ptr);
		break;
	case SOAP_TYPE_PointerToxsd__float:
		soap_mark_PointerToxsd__float(soap, (float *const*)ptr);
		break;
	case SOAP_TYPE_PointerToPointerToxsd__int:
		soap_mark_PointerToPointerToxsd__int(soap, (long **const*)ptr);
		break;
	case SOAP_TYPE_PointerToxsd__int:
		soap_mark_PointerToxsd__int(soap, (long *const*)ptr);
		break;
	case SOAP_TYPE_PointerToxsd__string:
	...
	case SOAP_TYPE_string:
		...
		break;
	case SOAP_TYPE_Array2Ofint:
		soap_mark_Array2Ofint(soap, (int (*))ptr);
		break;
	}
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_m__echoVoid(struct soap *soap, struct m__echoVoid const*a)
{
	soap_mark_m__echoVoid(soap, a);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_mark_m__echoVoid(struct soap *soap, const struct m__echoVoid *a)
{
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_m__echoVoidResponse(struct soap *soap, struct m__echoVoidResponse const*a)
{
	soap_mark_m__echoVoidResponse(soap, a);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_mark_m__echoVoidResponse(struct soap *soap, const struct m__echoVoidResponse *a)
{
}
...
SOAP_FMAC3 struct SOAP_ENV__Header * SOAP_FMAC4 soap_in_SOAP_ENV__Header(struct soap *soap, const char *tag, struct SOAP_ENV__Header *a, const char *type)
{
	...
	{	for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_h__someUnknownRequest && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_string(soap, "h:someUnknownRequest", &a->h__someUnknownRequest, ""))
				{	soap_flag_h__someUnknownRequest = 0;
					continue;
				}
			if (soap_flag_h__someUnknownRequest_ && soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC3 struct s__SOAPArrayStruct * SOAP_FMAC4 soap_in_s__SOAPArrayStruct(struct soap *soap, const char *tag, struct s__SOAPArrayStruct *a, const char *type)
{
	...
	{	for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_varString && soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC3 struct ns__echoSimpleTypesAsStruct * SOAP_FMAC4 soap_in_ns__echoSimpleTypesAsStruct(struct soap *soap, const char *tag, struct ns__echoSimpleTypesAsStruct *a, const char *type)
{
	...
	{	for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_inputString && soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC3 struct ns__echoStructAsSimpleTypesResponse * SOAP_FMAC4 soap_in_ns__echoStructAsSimpleTypesResponse(struct soap *soap, const char *tag, struct ns__echoStructAsSimpleTypesResponse *a, const char *type)
{
	...
	{	for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag__outputString && soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC3 struct ns__echoDecimal * SOAP_FMAC4 soap_in_ns__echoDecimal(struct soap *soap, const char *tag, struct ns__echoDecimal *a, const char *type)
{
	...
	{	for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_inputDecimal && soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC3 struct ns__echoDate * SOAP_FMAC4 soap_in_ns__echoDate(struct soap *soap, const char *tag, struct ns__echoDate *a, const char *type)
{
	...
	{	for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_inputDate && soap->error == SOAP_TAG_MISMATCH)
